...
def Display_T():
    ...
    if Recorded:
        ...
        TimeCounter_Label.config(
            text=str(Hrs) + ':' + str(Mins) + ':' + str(Secs))
        Secs += 1
...
Button_Rec = Button(frame, text='REC', command=Starts_Recording, font=(
    "Times new roman", 30, "bold"), bg='#e50914',  activebackground='#ab070f')
Button_Rec.grid(row=20, column=2)

TimeCounter_Label = Label(frame, text='0:0:0', font=(
